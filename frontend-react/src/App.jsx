      ...
      <main className="w-full max-w-5xl space-y-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-2 flex flex-col gap-8">
            ...
            <section className="bg-slate-900/30 backdrop-blur-md p-8 rounded-2xl shadow-xl border border-white/5 flex flex-col justify-between hover:border-white/10 transition-colors duration-300">
              <div>
          ...
          <section className="bg-slate-900/30 backdrop-blur-md p-8 rounded-2xl shadow-xl border border-white/5 hover:border-white/10 transition-colors duration-300">
        ...
        <section className="space-y-6">
          <h3 className="text-2xl font-extrabold text-white border-b border-white/5 pb-3 tracking-wide">Live Systems & Telemetry</h3>
